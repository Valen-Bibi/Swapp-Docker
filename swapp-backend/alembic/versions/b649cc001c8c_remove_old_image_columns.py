"""remove_old_image_columns

Revision ID: b649cc001c8c
Revises: f47cb62c1370
Create Date: 2026-08-06 23:58:50.867168
...
revision: str = 'b649cc001c8c'
down_revision: Union[str, None] = 'f47cb62c1370'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['updated_by'], ['swapp.users.user_id'], ),
