...
class ProductoCatalogoResponse(BaseModel):
    ...
    sale_price: Optional[float] = None # Se mantiene en la respuesta porque se calcula dinámicamente en FastAPI
    main_image_url: Optional[str] = None
    description: Optional[str] = None 
    short_description: Optional[str] = None
    stock_quantity: int = 0
    category_id: Optional[int] = None
    tax_class_id: Optional[int] = None # Añadido
...
class ProductUpdateSchema(BaseModel):
    ...
    brand_id: Optional[int] = None
    tax_class_id: Optional[int] = None # Añadido
    # Eliminado: sale_price (la base de datos y el motor de ofertas se encargan ahora)
...
# --- MOVIMIENTOS DE INVENTARIO (ACTUALIZADO) ---
class ProductMovementCreate(BaseModel):
    quantity: int
    movement_type: str # Añadido: ej. 'ingreso', 'egreso', 'purchase'
    reason: str
    notes: Optional[str] = None
    unit_cost: Optional[float] = None # Añadido: costo por unidad en compras
