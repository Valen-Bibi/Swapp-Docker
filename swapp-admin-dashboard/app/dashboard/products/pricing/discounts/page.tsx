...
export default function OffersPage() {
	...
	return (
		<div className="p-6 relative">
			...
			<div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
				...
				<div className="flex items-center gap-4">
					...
					<GlassFilterToggle
						...
						labelOn="Viendo Historial"
						labelOff="Ver Historial de Ofertas"
						checked={showHistory}
			...
			<GlassTableWrapper>
				<GlassTableHead>
					<GlassTh>Producto / Alcance</GlassTh>
					<GlassTh>Campaña</GlassTh>
					<GlassTh>Descuento</GlassTh>
					<GlassTh>Validez</GlassTh>
					<GlassTh align="center">Estado</GlassTh>
									...
									<td className="px-6 py-4 text-center">
										<div className="flex justify-center">
											<TableActionIcon
												...
												variant={d.is_active ? "glass-success" : "default"}
